...
//	
	@PostMapping("addingProduct")
	public String addProduct(@ModelAttribute Product product) {
	    // Ensure that the product entity now contains the image URL
	    productServices.addProduct(product); // Save the product to the database
	    return "redirect:/admin/services"; // Redirect to the product listing page
	}
